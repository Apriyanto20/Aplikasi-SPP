...
<body id="laporan">
    ...
    <div class="row mx-0 mt-2 identity">
      <div class="col-12" style="font-size: 12px;">
        ...
        <span class="fw-normal fs-sm pt-0">Uang Sejumlah <span class="ms-4" style="padding-left: 12px;">:<i> {{ rupiahTerbilang($detailpembayaran->jumlah_bayar) }} Rupiah</i></span></span><br>
      </div>
    </div>
