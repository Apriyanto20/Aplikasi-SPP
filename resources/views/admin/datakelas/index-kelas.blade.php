        ...
        <div class="card-body">
          ...
          <form class="row g-3" action="/datakelas" method="POST">
            ...
            <div class="col-12 px-3 px-md-2">
              ...
              <input type="text" name="kelas" class="form-control form-control-smx roundedx @error('kelas') is-invalid @enderror" placeholder="ex: XII RPL 2" id="namaKelas" autocomplete="off" value="{{ old('kelas') }}">
              @error('kelas')
