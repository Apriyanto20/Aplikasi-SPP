        ...
        <div class="row mx-0 mx-md-4 mx-lg-4">
          ...
          <div class="col-12 col-md-6 col-lg-6 pe-0 pe-md-3 pe-lg-3 mt-0 mt-md-3 mt-lg-3">
            <div class="col-12 col-md-12 col-lg-12 detail-form">
              ...
              <div class="col-12 mb-2">
                <div class="row ">
                  <small class="title-profile-top">Jenis Kelamin</small>
                  <h6 class="mb-0 fw-normal fs-12">{{ auth()->user()->jenis_kelamin }}</h6>
                </div>
              </div>
              <div class="col-12 mb-2">
                <div class="row ">
...
<footer id="footer" class="footer mt-5">
  <div class="copyright">
    &copy; Copyright 2023 - <strong><span>@AdiApriyanto</span></strong>
  </div>
</footer> 
@endsection