          ...
          <form class="row g-3 mx-0 mx-md-1 mx-lg-1 mb-3" action="/dataadmin/{{ $dataadmin->id }}" method="POST">
            ...
            <div class="col-12 col-md-6 col-lg-6 pe-2 pe-md-3 pe-lg-3">
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" name="jenis_kelamin" class="form-control form-control-smx roundedx @error('jenis_kelamin') is-invalid @enderror" value="{{ $dataadmin->jenis_kelamin, old('jenis_kelamin') }}" placeholder="Masukkan jenis_kelamin" id="jenis_kelamin" autocomplete="off">
                @error('jenis_kelamin')
                  <span class="invalid-feedback">{{ $message }}</span>
                @enderror
              </div>
